...
export class ReplaceStep extends Step {
  ...
  //
  // > 指定的 slice 应该适应这个介于 `from` 和 `to` 之间的 「gap」，即 slice 两侧的深度和各自所接起来的位置深度必须是相同的，且 slice 周围
...
export class ReplaceAroundStep extends Step {
  ...
  //
  // > 用指定的 range 和 gap 来新建一个 replace-around step。 `insert` 应该指向的是在 slice 中 gap 的内容应该被放置的位置。
